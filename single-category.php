            ...
            <div class="container"> 
                <div class="row sec-mar"> 
                    <div class="col-md-9 col-sm-9 pull-right left-blk"> 
                        ...
                        <figure class="bm-50">
                            <img src="assets/images/electronics/mobile-banner.jpg" alt="">
                        </figure>

                        <div class="bdr-title">
                            <h3><span>Mobile phones</span></h3>
                        </div> 
                        ...
                        <div class="product-wrap product-listing">
                            <ul class="products">
                                <li class="product">
                                    ...
                                    <h4><a href="#">Samsung galaxy S9</a></h4> 
                                </li>
                                <!--product-->
                                ...
                                <li class="product last">
                                    <figure class="img-animi">
                                        ...
                                        <a href="#"><img src="assets/images/electronics/product9.jpg" alt=""></a>
                                    </figure>
                                ...
                                <li class="product">
                                    <figure class="img-animi">
                                        ...
                                        <a href="#"><img src="assets/images/electronics/product10.jpg" alt=""></a>
                                    </figure>
                                ...
                                <li class="product">
                                    <figure class="img-animi">
                                        ...
                                        <a href="#"><img src="assets/images/electronics/product11.jpg" alt=""></a>
                                    </figure>

                                    <div class="price-wrap">
                                        <div class="price"><ins>RM119.00 </ins></div>
                                        <div class="star-rate">
                                            <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-half-full"></i>
                                        </div>
                                    </div>

                                    <h4><a href="#">Iphone 7s</a></h4> 
                                </li>
                                <!--product-->
                                ...
                                <li class="product last">
                                    <figure class="img-animi">                                   
                                        ...
                                        <a href="#"><img src="assets/images/electronics/product12.jpg" alt=""></a>
                                    </figure>
                                ...
                                <li class="product">
                                    <figure class="img-animi"> 
                                        ...
                                        <a href="#"><img src="assets/images/electronics/product13.jpg" alt=""></a>
                                    </figure>

                                    <div class="price-wrap">
                                        <div class="price"><del>RM90.00</del><ins>RM80.00 </ins></div>
                                        <div class="star-rate">
                                            <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-half-full"></i>
                                        </div>
                                    </div>
