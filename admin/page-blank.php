        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Blank Page</h6>
                    ...
                    <div class="widget-holder col-md-12">
                        <div class="widget-bg">
                            <div class="widget-heading widget-heading-border">
                                ...
                                <div class="widget-actions"><a href="#" class="badge bg-info-contrast px-3 cursor-pointer heading-font-family">Additional Link</a>
                                </div>
                                <!-- /.widget-actions -->
                            </div>
                            <!-- /.widget-heading -->
