                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="account-content">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="address">
                                        <div class="address-title bm-20">         
                                            <h6 class="bm-0">Billing address </h6>
                                            <span class="edit"><a href="#"><i class="fa fa-edit"></i> Edit</a></span>
                                        </div>

                                        <p>
                                            John Doe <br>
                                            1234 South Avenue  <br>
                                            Johor Bahru <br>
                                            Johor
                                        </p>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                     <div class="address">
                                        <div class="address-title bm-20">         
                                            <h6 class="bm-0">Shipping address </h6>
                                            <span class="edit"><a href="#"><i class="fa fa-edit"></i> Edit</a></span>
                                        </div>
