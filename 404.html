...
<head>
    ...
    <title>404 Not Found - Neostore</title>
                ...
                <div class="row sec-padding">
                    <div class="col-md-6 col-sm-6 col-md-offset-3 col-sm-offset-3 text-center">
                        <div class="sec-padding">
                            <figure class="bm-20 error-pg-fig"><img src="assets/images/404.png" alt=""></figure>
                            <h5>We are so sorry, but the page you requested is not available</h5> 
                            <a class="btn btn-link faa-parent animated-hover"><i class="fa fa-long-arrow-left faa-passing"></i> Go back to home page</a>
                        </div>
                    </div>
                </div>              
            </div>  
